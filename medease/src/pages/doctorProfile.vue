...
// Function to check if user is logged in (for edit functionality)
const isUserLoggedIn = () => {
  return true; // Temporarily return true to test edit functionality
  // const currentUser = sessionStorage.getItem('currentDoctor');
  // if (!currentUser) return false;
  
  // const doctorId = parseInt(currentUser);
